...
\def\myfititle{Diffuusiopohjaisen tekstistä kuvaksi -mallin hyödyntäminen kohteentunnistuksessa}
\def\myentitle{Utilizing Diffusion-Based Text-To-Image Model In Object Detection}
\def\myauthor{Otto Väyrynen}
\def\myfisubtitle{}
\def\myensubtitle{}
\def\myfithesistype{Diplomityö}
\def\myenthesistype{Master of Science Thesis}
\def\myexaminers{Prof. Joni Kämäräinen}
...
\def\myenprogrammename{Master's Degree Programme in Information Technology}
\def\myfikeywords{Kohteentunnistus, Konenäkö, Koneoppiminen, Synteettinen data, Synteettisen datan generointi, Synteettisestä todelliseen, Diffuusiomalli}
\def\myenkeywords{Object Detection, Computer Vision, Machine Learning, Synthetic Data, Synthetic Data Generation, Syn2Real, Diffusion Model}
...
% Add all acronyms to the main glossary
% Print the acronyms glossary
\printglossary[type=\acronymtype,title= LIST OF SYMBOLS AND ABBREVIATIONS, toctitle= ]
\renewcommand{\glossarysection}[2][]{\par\noindent\textbf{#2}\par\vspace{0.5em}}
